...
export const ArenaTable = () => {
    const data=[
        {title:'ARAM Cup 7',caption:'Best 1 Games',starts:'Apr 15',duration:'24 hours',registered:'1.2k',price:'$50'},
        {title:'ARAM Cup 7',caption:'Best 1 Games',starts:'Apr 15',duration:'24 hours',registered:'1.2k',price:'$50'},
        {title:'ARAM Cup 7',caption:'Best 1 Games',starts:'Apr 15',duration:'24 hours',registered:'1.2k',price:'$50'},
        {title:'ARAM Cup 7',caption:'Best 1 Games',starts:'Apr 15',duration:'24 hours',registered:'1.2k',price:'$50'},
        {title:'ARAM Cup 7',caption:'Best 1 Games',starts:'Apr 15',duration:'24 hours',registered:'1.2k',price:'$50'},
        ...
        <table className={classes.table}>
            ...
            <thead className={classes.tHead}>
                <tr className={classes.headRow}>
                    <th className={classes.head}><span className={`${classes.typeCaption} ${classes.action}`}>Game & Event Name</span></th>
                    <th className={classes.head}><span className={`${classes.typeCaption} ${classes.action}`}>Starts</span></th>
                    <th className={classes.head}><span className={`${classes.typeCaption} ${classes.action}`}>Duration</span></th>
                    <th className={classes.head}><span className={`${classes.typeCaption} ${classes.action}`}>Registered</span></th>
                    <th className={classes.head}><span className={`${classes.typeCaption} ${classes.action}`}>Prize Pool</span></th>
                </tr>
            </thead>
