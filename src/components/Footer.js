    ...
    <div className={classes.footer}>
      <div className={classes.row}>
        <div className={classes.actionCol}>
          ...
          <a
            className={`${classes.downloadAction}  ${classes.window}`}
            title="Windows 64-bit"
          >
            <AiFillWindows style={{ fontSize: 24, marginRight: 10 }} /> Download
          </a>
          <a
            className={`${classes.punchAction}  ${classes.punch}`}
            title="Windows 64-bit"
          >
      ...
      <div className={classes.secondRow}>
        ...
        <span className={classes.info}>English</span>
        <span className={classes.info}>Terms of Service</span>
        <span className={classes.info}>Privacy Policy</span>
      </div>
    </div>
  );
};
